					...
					<ol>
						<li>
							...
							<p>
								...
								предпринимаемые Владимировым Виктором Алексеевичем (далее — Оператор).
							</p>
							<ol>
								<li>
									<p>
							...
							<ol>
								...
								<li>
									<p>
										...
										данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://olp.su.
									</p>
								</li>
								<li>
									<p>
								...
								<li>
									<p>
										...
										определяемому Пользователю веб-сайта https://olp.su.
									</p>
								</li>
								<li>
									<p>
								...
								<li>
									<p>2.10. Пользователь — любой посетитель веб-сайта https://olp.su.</p>
								</li>
								<li>
									<p>
									...
									<ul>
										...
										<li>
											<p>
												...
												также, направления обращения с требованием о прекращении обработки персональных данных, Оператор
						...
						<li>
							...
							<ol>
								...
								<li>
									...
									<ul>
										<li>
											<p>Фамилия, имя, отчество Электронный адрес Номера телефонов</p>
										</li>
									</ul>
								</li>
								<li>
							...
							<ol>
								...
								<li>
									<p>
										...
										info@olp.su с пометкой «Актуализация персональных данных».
									</p>
								</li>
								<li>
									<p>
										...
										Оператору уведомление посредством электронной почты на электронный адрес Оператора info@olp.su с
							...
							<ol>
								<li>
									<p>
										...
										его персональных данных, обратившись к Оператору с помощью электронной почты info@olp.su.
									</p>
								</li>
								<li>
									<p>
